...
public class HeroBannerComponent extends CommonComponent {
    ...
    public void doBeforeRender(HstRequest request, HstResponse response) {
        ...
        HeroBannerComponentInfo paramInfo = this.getComponentParametersInfo(request);

        request.setModel("heroBannerDocument", getHippoBeanForPath(paramInfo.getHeroBannerDocument(), HeroBanner.class));
    }
