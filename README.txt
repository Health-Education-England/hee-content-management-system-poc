...
After your project is set up, access the CMS at <http://localhost:8080/cms> and the site at <http://localhost:8080/heeweb>.
...
as uk.nhs.hee.web/hee-web:0.1.0-SNAPSHOT
